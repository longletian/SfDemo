...
namespace Slickflow.WebDemo.Controllers
{
    ...
    public class WfController : Controller
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        [HttpPost, Route("QueryProcessFile")]
        ...
        [HttpPost, Route("GetNextStepInfo")]
        ...
        /// <returns></returns>
        [HttpPost,Route("QueryProcessRoles")]
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        [HttpPost, Route("QueryProcessRoleUserList")]
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        [HttpGet, Route("GetUserByRole/{id}")]
        ...
        [HttpPost, Route("QueryReadyTasks")]
        ...
        [HttpPost, Route("QueryReadyActivityInstance")]
        ...
        [HttpPost, Route("QueryCompletedTasks")]
