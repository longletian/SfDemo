...
const actions = {
  getToDo: (context, payload) => {
    ...
    axios.post(`${process.env.VUE_APP_BASE_URL}/wf/QueryReadyTasks`, query)
      .then((response) => {
  ...
  getDone: (context, payload) => {
    ...
    if (user !== null) {
      ...
      axios.post(`${process.env.VUE_APP_BASE_URL}/wf/QueryCompletedTasks`, query)
        .then((response) => {
  ...
  getCreated: (context, payload) => {
    ...
    axios.post(`${process.env.VUE_APP_BASE_URL}/wf/QueryCreatedTasks`, query)
      .then((response) => {
        var donetasks = response.data.Entity
        context.commit('setDone', donetasks)
      })
  ...
  rejectTask: (context, payload) => {
    ...
    axios.post(`${process.env.VUE_APP_BASE_URL}/wf/RejectProcess`, query)
      .then((response) => {
