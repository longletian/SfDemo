...
const actions = {
  getLeave: (context, payload) => {
    ...
    axios.get(`${process.env.VUE_APP_BASE_URL}/api/HrsLeave/GetLeave/` + leaveID)
      .then((response) => {
  ...
  queryLeave: (context, payload) => {
    ...
    if (user !== null) {
      ...
      axios.post(`${process.env.VUE_APP_BASE_URL}/HrsLeave/queryLeave/`, query)
        .then((response) => {
  ...
  submitLeave: (context, payload) => {
    ...
    var callback = payload.callback
    axios.post(`${process.env.VUE_APP_BASE_URL}/HrsLeave/CreateNewLeave`, entityRunner)
      .then((response) => {
  ...
  saveLeave: (context, payload) => {
    ...
    var callback = payload.callback
    axios.post(`${process.env.VUE_APP_BASE_URL}/HrsLeave/UpdateLeave`, entity)
      .then((response) => {
        var result = response.data
