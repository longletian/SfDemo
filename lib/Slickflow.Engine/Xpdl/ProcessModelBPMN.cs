...
namespace Slickflow.Engine.Xpdl
{
    ...
    public class ProcessModelBPMN : IProcessModel
    {
        ...
        private Process ConvertProcessModelFromXML()
        {
            ...
            {
                XmlNamespaceManager xmlNamespace = XPDLHelper.GetSlickflowXmlNamespaceManager(xmlDoc);

                var xmlNodeProcess = root.SelectSingleNode(XPDLDefinition.BPMN2_StrXmlPath_Process, xmlNamespace);
